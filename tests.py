...
g1_2_8_g0 = np.load('/Users/delis/Desktop/g1/g1_x_28_g_0.npy')
D1_2_8_g0 = np.load('/Users/delis/Desktop/g1/D1_x_28_g_0.npy')

fig, ax = pl.subplots(1,1, figsize=(8,8))
ax.set_xscale('log')
ax.set_yscale('log')
ax.plot(-2*np.log(np.abs(g1_2_7)/D1_2_7), label=r'$N=2^7, g=6.4522, g_r=0.1455$')
ax.plot(-2*np.log(np.abs(g1_2_8)/D1_2_8), label=r'$N=2^8, g=6.4522, g_r=0,1455$')
ax.plot(-2*np.log(np.abs(g1_2_8_g0)/D1_2_8_g0), label=r'$N=2^8, g=0, g_r=0$')
ax.plot(0.001*np.arange(128)**(2*0.39))
