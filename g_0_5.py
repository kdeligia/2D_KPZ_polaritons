...
def g1(i_batch):
    ...
    name_full1 = '/scratch/konstantinos/g_0_5'+os.sep+'n_batch'+str(i_batch+1)+'.dat'
    np.savetxt(name_full1, correlator_batch, fmt='%.5f')

qutip.settings.num_cpus = n_batch
parallel_map(g1, range(n_batch))

path1 = r"/scratch/konstantinos/g_0_5"
...
np.savetxt('/home6/konstantinos/g_0_5.dat', result)