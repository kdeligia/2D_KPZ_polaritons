...
params_init['N'] = [160]                                                                                                  # dimensionless!
params_init['dx'] = [0.2]                                                                                                # dimensionless!
...
for dt in [5e-6, 1e-5, 5e-5]:
    if dt == 5e-6:
        di = 500                                                                                                                       # sample step
        N_input = 2.5e6                                                                                                                # number of time steps
    elif dt == 1e-5:
        di = 250
        N_input = 1.25e6
    elif dt == 5e-5:
    ...
    for i in range(0, int(N_input)+1, di):
        ...
        if ti >= 0 and i % di == 0:
            t.append(ti)
    #print(np.array(t), len(np.array(t)))
